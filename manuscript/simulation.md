...
Probably the most common probability distribution to work with is the Normal distribution (also known as the Gaussian). Working with the Normal distribution requires using these four functions
...
Here we simulate 10 standard Normal random numbers with mean 0 and standard deviation 1.
...
> x <- rnorm(10)   
> x
 [1]  0.01874617 -0.18425254 -1.37133055 -0.59916772  0.29454513  0.38979430 -1.20807618 -0.36367602 -1.62667268 -0.25647839
```

We can modify the default parameters to simulate 10 numbers with mean 20 and standard deviation 2.


```r
> x <- rnorm(10, 20, 2) 
> x
 [1] 22.20356 21.51156 19.52353 21.97489 21.48278 20.17869 18.09011 19.60970 21.85104 20.96596
> summary(x)
...
We can also simulate from a *generalized linear model* where the errors are no longer from a Normal distribution but come from some other distribution. For example, suppose we want to simulate from a Poisson log-linear model where
