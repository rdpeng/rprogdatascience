...
indices. Here, we create simple {$$}2\times 3{/$$} matrix with the `matrix`
function.
...
returned as a vector of length 1 rather than a {$$}1\times 1{/$$}
...
{$$}1\times 3{/$$} matrix after extracting the first row, we get a vector of
